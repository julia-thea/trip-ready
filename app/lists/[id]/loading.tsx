    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      ...
      <main className='max-w-4xl mx-auto px-8 pt-12 animate-pulse'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          <div className='bg-white border border-silver rounded-xl p-6 space-y-3 shadow-sm'>
            <div className='h-10 w-full bg-ivory rounded-xl border border-silver mb-2' />
            {[1, 2, 3, 4].map((i) => (
          ...
          <div className='bg-white border border-silver rounded-xl p-6 space-y-4 h-fit shadow-sm'>
            <div className='h-4 w-24 bg-silver/70 rounded' />
            <div className='h-5 w-36 bg-silver/50 rounded' />
